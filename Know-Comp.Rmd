...
```{r, echo=FALSE, fig.cap="Determining Silicon or Intel Processor", out.width = '100%'}

knitr::include_graphics("imgs/Mac_install_info.png")
```
...
```{r, echo=FALSE, fig.cap="Example of Download Differences", out.width = '100%'}

knitr::include_graphics("imgs/Mac_Download_Example.png")
```
...
```{r, echo=FALSE, fig.cap="Important Windows Edition and Versions", out.width = '100%'}

knitr::include_graphics("imgs/Windows_Versions.png")
```
...
```{r, echo=FALSE, fig.cap="The Blackbox of the Terminal", out.width = '100%'}

knitr::include_graphics("imgs/Terminal_Example.png")
```
...
```{r, echo=FALSE, fig.cap="Common Depiction of Shell Scripting", out.width = '100%'}

knitr::include_graphics("imgs/Matrix.jpeg")
```
